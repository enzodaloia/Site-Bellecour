...
<a class="btn btn-primary" href="https://www.tcl.fr/sites/default/files/2022-09/Plan_Lyon-Villeurbanne_ao%C3%BBt22_0.pdf" role="button" target="_blank">Link to the PDF</a>
<div id="FormTransport">
...
<div class="col-md-6">
	<div id="carouselTest" class="carousel carousel-dark slide" data-bs-ride="carousel">
	  ...
	  <br>
		...
		<a class="btn btn-primary" href="https://velov.grandlyon.com/fr/home" type="submit" target="_blank">Link to the velo'v website</a>
		<div id="FormTransport">
			...
			<div id="FormTransport">
				<div class="col-md-6">
					...
					<a class="btn btn-primary" href="https://www.tier.app/fr/" type="submit" target="_blank">Link to the Tier website</a>
					<a class="btn btn-primary" href="https://velov.grandlyon.com/fr/home" type="submit" target="_blank">Link to the Dott website</a>
