...
<article>
    ...
    <p>Place Bellecour is the largest square in Lyon (62,000 m²) and the fifth largest in France.<br>
         <br>Place de France and the largest pedestrian square in Europe. It is trapezoidal in shape, <br>
         measuring 300 metres by 220 metres on one side and 190 metres on the other<br>
         At its centre is the equestrian statue of Louis XIV. Another statue representing the  <br>
        <br>Petit Prince and Antoine de Saint-Exupéry is located at the southwestern end of the square. <br>
		There are also two pavilions serving the tourist office, a small children's park, a fountain and two bars.
    </center>
    </article>
</p>
</div>
...
<div id="titrevjhist" class="container-fluid">
   ...
   <p>This square is now located in the second arrondissement of the city on the peninsula, between the Saône and the Rhône.<br>
    ...
    <ul>
        <i>rue de la République, which leads to the Place de la Comédie between the Town Hall and the Opera House</i><br>
        <i>then onto Place Louis-Pradel via Rue du Puits-Gaillot on the north side</i><br>
        <i>rue Victor-Hugo, leading to Perrache on the south side</i><br>
